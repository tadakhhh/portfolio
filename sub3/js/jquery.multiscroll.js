...
(function($, window, document, Math, undefined) {
    ...
    $.fn.multiscroll = function(options) {
        ...
        options = $.extend({
            ...
            'paddingBottom': 0,
            'fixedElements': null,
            'normalScrollElements': '.title_area, #footerArea',
        ...
        */
        ...
        function reBuild(resizing){
            ...
            $('.ms-tableCell').each(function() {
                $(this).css({ height: 700($(this).parent()) });
            });
        ...
        */
        function addTableClass(element){
            element.addClass('ms-table').wrapInner('<div class="ms-tableCell" style="height: 700px" />');
        }
