 window.onload = function() {
    ...
    var options = {
        center: new daum.maps.LatLng(37.489686, 128.196737),
        level: 2
    };
    ...
    var markerPosition  = new daum.maps.LatLng(37.489686, 128.196737); 
    ...
    var options2 = {
        center: new daum.maps.LatLng(37.515357, 127.065512),
        level: 2
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(37.515357, 127.065512); 
   ...
   var options3 = {
       center: new daum.maps.LatLng(37.441624,127.176474),
       level: 2
   };
   ...
   var markerPosition3  = new daum.maps.LatLng(37.441624,127.176474); 
